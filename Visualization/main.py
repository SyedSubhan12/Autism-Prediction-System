...
def main(file_path, output_path):
    ...
    numerical_columns = ['age', 'result']  # Adjusted based on dataset
    ...
    numerical_pairs = [('age', 'result')]  # Example pairs from dataset
    plot_scatter_relationships(df, numerical_pairs, output_path)

    # Pie chart for categorical proportions
    plot_pie_chart(df, 'gender', output_path)  # Adjust column name as needed

    print("Analysis completed. All plots saved to the output directory, including interactive visualizations.")

# Example usage
file_path = 'Data/train/train_transformed.csv'  # Replace with uploaded dataset file path
